...
namespace VeldridFormsSamples.ComputeTexture
{
    public class ComputeTextureApplication : SampleApplication
    {
        ...
        public ComputeTextureApplication(IApplicationWindow window) : base(window) { }
