...
namespace VeldridFormsSamples.ComputeParticles
{
    public class ComputeParticlesApplication : SampleApplication
    {
        ...
        public ComputeParticlesApplication(IApplicationWindow window) : base(window)
        {
        }
